...
import { appendChild, createDerivedState, EMPTY_OBJ, findDOMfromVNode, moveVNodeDOM, options, removeChild, removeVNodeDOM, replaceChild, setTextContent } from './utils/common';
...
export function patch(lastVNode, nextVNode, parentDOM, context, isSVG, nextNode, lifecycle) {
...
export function patchSingleTextChild(lastChildren, nextChildren, parentDOM) {
...
export function patchElement(lastVNode, nextVNode, context, isSVG, nextFlags, lifecycle) {
...
export function updateClassComponent(instance, nextState, nextProps, parentDOM, context, isSVG, force, nextNode, lifecycle) {
