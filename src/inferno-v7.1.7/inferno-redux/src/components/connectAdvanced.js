...
export function connectAdvanced(selectorFactory, { getDisplayName = getDefaultName, methodName = 'connectAdvanced', renderCountProp = null, shouldHandleStateChanges = true, storeKey = 'store', withRef = false, ...connectOptions }) {
